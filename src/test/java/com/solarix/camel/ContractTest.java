...
import com.solarix.camel.model.Transactionfee;
...
//		String file = "src/test/resources/florian_licausi.json";
        credentialsFrom = WalletUtils.loadCredentials("piot123", "src/test/resources/florian_licausi.json");
        credentialsTo = WalletUtils.loadCredentials("piot123", "src/test/resources/gilles_coutard.json");
